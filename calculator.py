...
e = Entry(root, width=35, borderwidth=5, font=("Calibri 11"))
...
button_dot = Button(root, text=".", padx=41, pady=20, command=lambda: button_click("."), bg="white")

button_add = Button(root, text="+", padx=19, pady=20, command=button_add)
button_equal = Button(root, text="=", padx=39, pady=20, command=button_equal, bg="lightgreen")
button_clear = Button(root, text="Clear", padx=9, pady=15, command=button_clear, bg="lightgrey")
